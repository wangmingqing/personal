  ...
  <div>
    ...
    <div class="canvas-footer clearfix">
      <div class="fr clearfix">
        ...
        <div class="size-box fl clearfix">
          <div class="plus fl"><i class="el-icon-circle-plus"></i></div>
          <div class="input fl">{{percent}}</div>
          <div class="minus fl"><i class="el-icon-remove"></i></div>
        </div>
      </div>
    </div>
  </div>
