  ...
  <div>
    ...
    <div class="html-container">
      <div class="poster-container">
        ...
        <div class="player" data-type="text">这是一个神奇的国度2</div>
...
.player-control .top-left{left:-5px;top:-5px;}
.player-control .top-right{right:-5px;top:-5px;}
.player-control .bottom-left{left:-5px;bottom:-5px;}
.player-control .bottom-right{right:-5px;bottom:-5px;}
...
.player-control .top-center{top: -5px;}
.player-control .bottom-center{bottom: -5px;}
...
.player-control .left-center{left: -5px;}
.player-control .right-center{right: -5px;}
</style>