<template>
  <div>
    ...
    <div class="fabric-container">
      <div class="container">
        <canvas id="canvas" :width="documentWidth" :height="documentHeight"></canvas>
      </div>
    </div>
    <AsideRight
...
export default {
  ...
  methods: {
    init() {
      ...
      console.log()
      this.documentWidth = document.innerWidth
      this.documentHeight = document.innerHeight
      this.canvas = new fabric.Canvas('canvas')
      this.setCanvasSize(this.documentWidth, this.documentHeight)
    ...
    setBackgroundImage(url) {
      ...
      img.onload = () => {
        ...
        fabric.Image.fromURL(url, (img) => {
          ...
          left: this.documentWidth / 2 + this.canvasWidth / 2,
          top: this.documentHeight / 2 + this.canvasHeight / 2
        })
      }
    },
    plus() {
...
<style scoped>
.fabric-container{height:100%;overflow:hidden;}
