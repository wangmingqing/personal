  ...
  <div>
    ...
    <div class="html-container">
      <div class="poster-container">
        <div class="player" data-type="text" style="position:absolute;top:50px;left:50px;width:200px;">这是一个神奇的国度1</div>
    ...
    init() {
      ...
      topLeft.onmousedown = event => {
        ...
        document.onmousemove = event => {
          ...
          this.playerControl.style.width = this.currentPlayer.style.width
          this.playerControl.style.height = this.currentPlayer.style.height
          this.playerControl.style.top = this.currentPlayer.style.top
          this.playerControl.style.left = this.currentPlayer.style.left
        }
        document.onmouseup = () => {
          // 事件解绑
