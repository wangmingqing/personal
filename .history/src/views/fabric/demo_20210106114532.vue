<template>
  <div>
    ...
    <div class="html-container">
      <div class="poster-container" id="poster"></div>
    </div>
    <AsideRight/>
...
export default {
  ...
  methods: {
    ...
    // 本页方法
    init() {
      this.container = document.querySelector('#poster')
      ...
      this.container.onmousewheel = event => {
        ...
        this.container.style.webkitTransform = `translate(-50%, -50%) scale(${this.zoom})`
