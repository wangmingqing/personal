...
<script>
  ...
  export default {
    ...
    data() {
      return {
        fontFamily: [
          {fontFamily: '微软雅黑', fontName: '微软雅黑'},
          {fontFamily: '宋体 常规', fontName: '宋体 常规'},
          {fontFamily: '新宋体 常规', fontName: '新宋体 常规'},
          {fontFamily: 'DFKai-SB', fontName: '标楷体-SB'},
          {fontFamily: '黑体 常规', fontName: '黑体 常规'},
          {fontFamily: '锐字锐线怒放黑简1.0 常规', fontName: '锐字锐线怒放黑简1.0 常规'},
          {fontFamily: 'Helvetica', fontName: 'Helvetica'},
