    ...
    <div class="content">
      <div v-if="type === 'textbox'">
        ...
        <div class="font-item">
          ...
          <div class="list" v-if="openedFontFamily">
        ...
        <div class="font-item">
          ...
          <div class="list" v-if="openedFontSize">
        ...
        <div class="font-item">
          ...
          <div class="showColor">
            <div class="colorIcon" @click="showStrokeTwitter = !showStrokeTwitter" style="top:33px;"></div>
            <div class="choiceColor" @click="showStrokeChrome = !showStrokeChrome" :style="'background:' + activeStrokeColor"></div>
          </div>
          <div class="con" v-if="showStrokeChrome||showStrokeTwitter" style="top:72px;">
        ...
        <div class="font-item" v-if="shadow">
          <p style="padding-bottom:10px;">投影</p>
          <div class="showColor">
            <div class="colorIcon" @click="showShadowTwitter = !showShadowTwitter" style="top:33px;"></div>
            <div class="choiceColor" @click="showShadowChrome = !showShadowChrome" :style="'background:' + shadow.color"></div>
          </div>
          <div class="con" v-if="showShadowChrome||showShadowTwitter" style="top:72px">
        ...
        <div class="font-item fontgradient" v-if="gradient">
          ...
          <div class="con" v-if="showGradientFirstChrome || showGradientLastChrome" style="top:72px;">
      ...
      <div v-if="type === 'image'">
        <p style="padding-top:10px;">透明度</p>
        <div class="block">
          <el-slider
            :min="0"
            :max="1"
        ...
        <p style="padding-top:10px;">对比度</p>
        <div class="block">
          <el-slider
            :min="-1"
            :max="1"
        ...
        <div class="col">
          <el-dropdown @command="handleSort">
            ...
            <el-dropdown-menu slot="dropdown">
              <el-dropdown-item command="bringToFront">移至顶层</el-dropdown-item>
              <el-dropdown-item command="bringForward">上移一层</el-dropdown-item>
              <el-dropdown-item command="sendBackwards">下移一层</el-dropdown-item>
              <el-dropdown-item command="sendToBack">移至底层</el-dropdown-item>
            </el-dropdown-menu>
          </el-dropdown>
        </div>
    ...
    watch: {
      currentObject(obj) {
        if(obj) {
          ...
          if(this.type === 'image') {
            this.imageOpacity = obj.opacity || 1
          }
        }
      }
    },
    data() {
      return {
        fontFamily: [
          ...
          {fontFamily: 'fangsong', fontName: '仿宋'},
        ...
        type: 'textbox', // 编辑类型 textbox image
...
.font-item{position: relative;margin-bottom:20px;margin-top:20px;}
.font-item .showtext{
  height: 38px;
  border-radius: 2px;
...
.font-item .showtext p{line-height:38px;padding:0 10px;overflow: hidden;box-sizing:border-box;}
.font-item .showtext .point{
  position: absolute;
  top: 50%;
  margin-top:-8px;
  color: #333;
...
.font-item .showtext:hover{border:1px solid #ff4555;}
.font-item .showtext:hover i{color:#ff4555}

.font-item .showtext .box{
  width:40px;
  height:100%;
  position:absolute;
  top:0;
...
.font-item .showtext .box div{width:100%;height:19px;line-height:19px;text-align:center;color:#111}
.font-item .showtext .box div:first-child{border-bottom:1px solid #e6e6e6}
.font-item .list{
  width: 100%;
  max-height:300px;
  background: #fff;
...
.font-item{position:relative;margin-bottom:20px;}
.font-item .showColor{
  height: 38px;
  border-radius: 2px;
  border: 1px solid #e6e6e6;
...
.font-item .showColor:hover{border:1px solid #ff4555;}
.font-item .colorIcon{
  position:absolute;
  top: 0;
  right: 10px;
...
.font-item .choiceColor{border: 1px solid #e6e6e6;
  background: pink;
  cursor: pointer;
  width: 180px;
  height: 20px;
...
.fontgradient .choiceColor:last-child{margin-left:0;}
