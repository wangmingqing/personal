    ...
    <div class="content">
      ...
      <div class="set-fontgradient" v-if="gradient">
        ...
        <div class="showColor clearfix">
          <div class="choiceColor" @click="showGradientFirstChrome = !showGradientFirstChrome" :style="'background:#fff'"></div>
          <div class="choiceColor" @click="showGradientLastChrome = !showGradientLastChrome" :style="'background:#fff'"></div>
        </div>
        <div class="con" v-if="showGradientFirstChrome || showGradientFirstChrome">
          <Chrome v-model="gradent.colorStops[0].color" @input="selectGradient" v-if="showGradientFirstChrome"/>
          <Chrome v-model="gradent.colorStops[1].color" @input="selectGradient" v-if="showGradientLastChrome"/>
        </div>
