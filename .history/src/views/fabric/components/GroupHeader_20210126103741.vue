<template>
  <div>
    ...
    <el-dialog
      ...
      width="30%">
      <el-row>
        <el-col :span="12"><p>左对齐</p></el-col>
        <el-col :span="12"><p>右对齐</p></el-col>
        <el-col :span="12"><p>水平居中</p></el-col>
        <el-col :span="12"><p>垂直居中</p></el-col>
        <el-col :span="12"><p>顶部对齐</p></el-col>
        <el-col :span="12"><p>底部对齐</p></el-col>
      </el-row>
    </el-dialog>
  </div>
</template>
