    ...
    <div class="container" v-if="showDrawer">
      <div class="font-wrapper" v-if="asideType === 'font'">
        ...
        <div class="con" v-if="fontType === 1">
          <div class="item" v-for="(item, index) in fontStyle" :key="index" @click="selectFont">
            <div class="img">
...
export default {
  ...
  data() {
    return {
      ...
      fontStyle: [
        {style: 'normal', name: '常规', src: require('./img/normal.png')},
        {style: 'shadow', name: '阴影', src: require('./img/shadow.png')},
        {style: 'solid', name: '立体', src: require('./img/solid.png')},
        {style: 'neon', name: '霓虹', src: require('./img/neon.png')},
        {style: 'fault', name: '故障风', src: require('./img/fault.png')}
      ],
      fontParams: {
        left: 0,
        top:0,
  ...
  methods: {
    ...
    selectFont() {
      this.$emit('setFont', this.fontParams)
    },
