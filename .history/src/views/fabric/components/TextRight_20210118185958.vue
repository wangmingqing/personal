    ...
    <div class="content">
      ...
      <div class="set-fontstroke">
        ...
        <div class="con" v-if="showStrokeChrome||showStrokeTwitter">
          <Chrome v-model="activeStrokeColor" @input="selectFontColor" v-if="showStrokeChrome"/>
          <Twitter v-model="activeStrokeColor" @input="selectFontColor" v-if="showStrokeTwitter"/>
        </div>
        <p>宽度</p>
        <div class="block">
          <el-slider
  ...
  export default {
    ...
    methods: {
      ...
      selectFontColor(e) {
        ...
        console.log(this.activeFontColor)
        this.$emit('setFont', {
          type: 'fill',
...
.set-strokecolor{position:relative;margin-bottom:20px;}
.set-strokecolor .showColor{
  height: 38px;
  border-radius: 2px;
  border: 1px solid #e6e6e6;
  line-height: 38px;
...
.set-strokecolor .showColor:hover{border:1px solid #ff4555;}
.set-strokecolor .colorIcon{
  position:absolute;
  top: 0;
  right: 10px;
  width: 30px;
...
.set-strokecolor .choiceColor{border: 1px solid #e6e6e6;
  background: pink;
  cursor: pointer;
  width: 180px;
  height: 20px;
