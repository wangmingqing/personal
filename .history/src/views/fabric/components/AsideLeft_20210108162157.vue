...
<script>
var normal = require('@/assets/img/normal.png')
export default {
  name: 'AsideLeft',
  props: {
    canvasWidth: {
  ...
  data() {
    return {
      ...
      fontStyle: [
        {style: 'normal', name: '常规', src: normal},
        {style: 'shadow', name: '阴影', src: './img/shadow.png'},
        {style: 'solid', name: '立体', src: './img/solid.png'},
        {style: 'neon', name: '霓虹', src: './img/neon.png'},
        {style: 'fault', name: '故障风', src: './img/fault.png'}
      ],
      fontParams: {
        left: 0,
        top:0,
