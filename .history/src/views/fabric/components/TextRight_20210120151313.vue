    ...
    <div class="content">
      ...
      <div class="set-fontgradient" v-if="gradient">
        ...
        <div class="con" v-if="showGradientFirstChrome || showGradientLastChrome">
          <Chrome v-model="gradient.colorStops[0].color" @input="selectGradient" v-if="showGradientFirstChrome"/>
          <Chrome v-model="gradient.colorStops[1].color" @input="selectGradient" v-if="showGradientLastChrome"/>
        </div>
