<template>
  <div class="asideRight">
    ...
    <div class="content">
      ...
      <div class="set-fontshadow">
        <p style="padding-bottom:10px;">投影</p>
        <div class="showColor">
          <div class="colorIcon" @click="showShadowTwitter = !showShadowTwitter"></div>
          <div class="choiceColor" @click="showShadowChrome = !showShadowChrome" :style="'background:' + activeShadowColor"></div>
        </div>
        <div class="con" v-if="showShadowChrome||showShadowTwitter">
          <Chrome v-model="activeShadowColor" @input="selectShadowColor" v-if="showShadowChrome"/>
          <Twitter v-model="activeShadowColor" @input="selectShadowColor" v-if="showShadowTwitter"/>
        </div>
      </div>
      <!-- 设置图层 -->
