<template>
  <header class="header">
    <div class="fl">
      ...
      <a href="javascript:;" class="btn-reply" :class="undoBtnStatus ? '' : 'disabled'" title="后退" @click="undo"><i class="fa fa-rotate-left"></i></a>
      <a href="javascript:;" class="btn-forward" :class="redoBtnStatus ? '' : 'disabled'" title="前进" @click="redo"><i class="fa fa-rotate-right"></i></a>
      <a href="javascript:;" class="btn-forward" title="重置" @click="redo"><i class="el-icon-refresh"></i></a>
