<template>
  <div>
    ...
    <el-dialog
      ...
      width="30%">
      <el-row>
        <el-col :span="12"><span>左对齐</span></el-col>
        <el-col :span="12"><span>右对齐</span></el-col>
        <el-col :span="12"><span>水平居中</span></el-col>
        <el-col :span="12"><span>垂直居中</span></el-col>
        <el-col :span="12"><span>顶部对齐</span></el-col>
        <el-col :span="12"><span>底部对齐</span></el-col>
      </el-row>
    </el-dialog>
  </div>
</template>
