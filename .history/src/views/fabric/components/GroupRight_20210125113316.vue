        ...
        <div class="col">
          <el-dropdown @command="handleSort">
            ...
            <el-dropdown-menu slot="dropdown">
              <el-dropdown-item command="a">移至顶层</el-dropdown-item>
              <el-dropdown-item command="b">上移一层</el-dropdown-item>
              <el-dropdown-item command="c">下移一层</el-dropdown-item>
              <el-dropdown-item command="d">移至底层</el-dropdown-item>
            </el-dropdown-menu>
          </el-dropdown>
        </div>
