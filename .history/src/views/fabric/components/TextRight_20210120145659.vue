  ...
  <div class="asideRight">
    ...
    <div class="content">
      ...
      <div class="set-fontgradient" v-if="gradient">
        ...
        <div class="showColor">
          <div class="colorIcon" @click="showShadowTwitter = !showShadowTwitter"></div>
          <div class="choiceColor" @click="showShadowChrome = !showShadowChrome" :style="'background:#fff'"></div>
        </div>
        <p style="padding-top:10px;">渐变类型</p>
        <el-select v-model="gradient.type" placeholder="请选择">
...
.set-fontgradient .choiceColor{border: 1px solid #e6e6e6;
  background: pink;
  cursor: pointer;
  width: 180px;
  height: 20px;
