<template>
  <header class="header">
    <div class="fl">
      ...
      <a href="javascript:;" class="btn-reply disabled" title="后退" @click="undo"><i class="fa fa-rotate-left"></i></a>
      <a href="javascript:;" class="btn-forward" title="前进" @click="redo"><i class="fa fa-rotate-right"></i></a>
