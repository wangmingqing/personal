...
export default {
  ...
  data() {
    return {
      ...
      fontStyle: [
        ...
        {style: 'gradient', name: '渐变', src: require('@/assets/img/gradient.png')}
      ],
      fontParams: {
        left: 0,
        top: 0,
  ...
  methods: {
    ...
    selectFont(style) {
      ...
      if(style === 'solid') {
        params.fill = 'rgba(255,255,255,1)'
        params.stroke = '#333'
        params.strokeWidth = 1
        params.shadow = '#333 0 4px'
      }
      if(style === 'neon') {
        params.fill = 'rgba(255,27,203,1)'
        params.stroke = '#fff'
        params.strokeWidth = 1
        params.shadow = '#ff1bcb 0 0 5px'
      }
